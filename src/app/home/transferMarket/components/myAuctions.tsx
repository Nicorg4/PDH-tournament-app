              ...
              {players.map((player) => (
                <tr key={player.id} className="hover:bg-[white] hover:bg-opacity-10">
                  ...
                  <td className="border-b border-white border-opacity-30 p-3 text-center">
                    <button className="bg-[#ed6f6f] text-white p-2 rounded-md bg-opacity-80 hover:bg-gray-400 hover:bg-opacity-70 hover:text-[#ed6f6f]" style={{boxShadow:"rgba(0, 0, 0, 0.35) 0px 5px 15px", transition: "0.5s ease"}}><FaRegTrashCan/></button>
                  </td>
                </tr>
              ))}
            </tbody>
