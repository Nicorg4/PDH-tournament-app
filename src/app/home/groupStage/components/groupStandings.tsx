                    ...
                    <table className="w-full border-collapse">
                        ...
                        <tbody>
                            {group.teams.sort((a, b) => b.stats.points === a.stats.points ? b.stats.goal_diff - a.stats.goal_diff : b.stats.points - a.stats.points).map((groupTeam, index) => (
                                <tr key={`group-${group.group_id}-team-${groupTeam.team.id}-${index}`} className="border-b border-slate-500  text-slate-800">
                                    ...
                                    <td className="pb-3 pt-3 text-center text-slate-800">{groupTeam.stats.wins + groupTeam.stats.draws + groupTeam.stats.losses}</td>
                                    <td className="pb-3 pt-3 text-center text-slate-800">{groupTeam.stats.wins}</td>
                                    <td className="pb-3 pt-3 text-center text-slate-800">{groupTeam.stats.draws}</td>
                                    <td className="pb-3 pt-3 text-center text-slate-800">{groupTeam.stats.losses}</td>
                                    <td className="pb-3 pt-3 text-center text-slate-800">{groupTeam.stats.goal_diff}</td>
                                    <td className="pb-3 pt-3 text-center text-slate-800">{groupTeam.stats.points}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
